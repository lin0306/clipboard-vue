<template>
    <icon>
        <template #component>
            <svg t="1740023155961" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="2630" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200">
                <path
                    ...
                    :fill="themeColors.text" p-id="2631"></path>
            </svg>
        </template>
    </icon>
</template>
